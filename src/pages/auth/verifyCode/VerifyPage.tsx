                        ...
                        <InputOTPGroup className="flex justify-center w-full gap-5">
                          {Array.from({ length: 4 }).map((_, i) => (
                            <InputOTPSlot
                              key={i}
                              index={i}
                              className="w-14 h-14 sm:w-16 sm:h-16 text-center text-lg sm:text-xl font-semibold rounded-[10px]! border-2 border-[#097178] bg-transparent focus:outline-none focus:ring-2 focus:ring-teal-600 transition"
                            />
                          ))}
                        </InputOTPGroup>
                      </InputOTP>
