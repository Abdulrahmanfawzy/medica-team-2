...
export default function SignUpPage() {
  ...
  return (
    <div
      className="relative -rotate-180 min-h-screen w-full flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-cover bg-center"
      style={{
    ...
    >
      ...
      <Overlay />
      {/* Card */}
      <div className="rotate-180 my-12 w-full max-w-2xl bg-white/10 backdrop-opacity-10 rounded-3xl shadow-1xl px-12 py-4">
        {/* Logo + Title */}
